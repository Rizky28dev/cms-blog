...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Front Page">
        <!-- App title -->
        <title>LibraryArticle | Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.php" class="logo"><span>FP<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
